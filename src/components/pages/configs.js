...
function Configs(){
    ...
    const [slotCLP, setSlotCLP] = useState(0);
        ...
        if(dadosRecebidos !== null){
            if("flag" in dadosRecebidos){
                if(dadosRecebidos.flag === "loadScreen"){
                    ...
                    setSlotCLP(dadosRecebidos.slotCLP);
    ...
    const handleSalvar = () => {
        setDadosJson(
            {"flag": "ipChange", "_ip": ipConfig, "slotCLP": slotCLP, "user": user.name}
        )
    };
    ...
    //Trata alteração do Slot do CLP
    const handleSlotCLP = (e) => {
        setSlotCLP(e.target.value);
    };
    ...
    return(
        <div className="container">
            <div className="content">
                ...
                <div className="text_input">
                    <label>Slot do CLP:</label><p/>
                    <input type="text" value={slotCLP} onChange={handleSlotCLP}></input>
